...
- **Control:** You can disable game activity sharing directly inside your Discord client settings (*Settings → Activity Privacy*) or configure launcher settings accordingly.
...
- Runs as a low-overhead background process if enabled in Settings (*Settings → Tracer*).
