...
import { encodeEngines, encodeProjects } from './binarySerialize'
import {
  generateGradient,
  findUprojectFiles,
...
export function registerIpcHandlers(): void {
  ...
  // Engines
  ipcMain.handle('scan-engines', async (): Promise<ArrayBuffer> => {
    ...
    // Return binary-encoded engines for zero-copy transfer
    return encodeEngines(validEngines)
  })
  ...
  // Projects
  ipcMain.handle('scan-projects', async (): Promise<ArrayBuffer> => {
    ...
    // Return binary-encoded projects for zero-copy transfer
    return encodeProjects(validProjects)
  })
