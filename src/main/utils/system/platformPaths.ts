...
export function getAppDataDir(): string {
  const nativePaths = getCachedNativePaths()
  if (nativePaths?.appDataDir) return nativePaths.appDataDir
...
export function getCacheDir(): string {
  const nativePaths = getCachedNativePaths()
  if (nativePaths?.cacheDir) return nativePaths.cacheDir
...
export function getConfigDir(): string {
  const nativePaths = getCachedNativePaths()
  if (nativePaths?.configDir) return nativePaths.configDir
...
export function getProjectScanPaths(): string[] {
  const nativePaths = getCachedNativePaths()
  if (nativePaths?.projectScanPaths && nativePaths.projectScanPaths.length > 0) {
    return nativePaths.projectScanPaths
  }
...
export function getFabCachePaths(): string[] {
  const nativePaths = getCachedNativePaths()
  if (nativePaths?.fabCachePaths && nativePaths.fabCachePaths.length > 0) {
    return nativePaths.fabCachePaths
  }
...
export function getTracerDataDir(): string {
  const nativePaths = getCachedNativePaths()
  if (nativePaths?.tracerDataDir) return nativePaths.tracerDataDir
...
export function getEditorBinaryName(): string {
  const nativePaths = getCachedNativePaths()
  if (nativePaths?.editorBinaryName) return nativePaths.editorBinaryName
...
export function getTracerBinaryName(): string {
  const nativePaths = getCachedNativePaths()
  if (nativePaths?.tracerBinaryName) return nativePaths.tracerBinaryName
