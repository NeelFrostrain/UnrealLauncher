...
export const PLATFORM: string = (typeof window !== 'undefined' ? window.electronAPI?.platform : null) ?? 'win32'
...
export const UE_DEFAULTS: Omit<LaunchConfig, 'id' | 'name' | 'description'> = {
  ...
  noSplash: false, noLoadingScreen: false, noShaderCompile: false, unattended: false,
  extraArgs: ''
}
