...
### ✅ Added
- 📄 Documentation: Added `CHANGELOG.md`, `CONTRIBUTING.md`, `CODE_OF_CONDUCT.md`, and `SECURITY.md`.
- ⚡ Performance: Added lazy-loading for pages and optimized build configuration.
